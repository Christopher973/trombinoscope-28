              ...
              <div className="space-y-2">
                ...
                {member.phoneNumber && (
                  <div className="flex items-center">
                    ...
                    <a href={`tel:${member.phoneNumber}`} className="text-sm">
                      {member.phoneNumber}
                    </a>
                  </div>
                )}
          ...
          {directReports.length > 0 && (
            ...
            >
              <h2 className="text-lg font-semibold mb-3">
                Rapports directs ({directReports.length})
              </h2>
            ...
            {directReports.length > 0 && (
              <div className="mb-4 p-3 bg-amber-50 border border-amber-200 rounded-md text-sm">
                ...
                <p className="text-amber-700">
                  Ce membre a {directReports.length} rapport direct
                  {directReports.length !== 1 && "s"}. Leurs subordonnés directs
                  seront réaffectés à{" "}
                  {member.managerId ? "ce manager" : "aucun manager"}.
                </p>
              </div>
            )}
